...
STOPPED HERE:The XGBoost model has the highest accuracy (0.87) and the lowest KS (0.004). at the rest of the metrics and have a different metric to choose the model. It also has the highest precision (0.87) and highest true negative rate (0.86) of all the models trained, so it is the best model in terms of how well it can predict both positive and negative values.
